...
import { useRef, useEffect, KeyboardEvent, ClipboardEvent, forwardRef, useImperativeHandle } from 'react'
        ...
        {Array.from({ length }, (_, index) => (
          <input
            ...
            className={`
              ...
              dark:focus:ring-primaryDark dark:focus:border-primaryDark
