  ...
  const handleEnable2FA = async () => {
    ...
    try {
      ...
      if (response?.code === 200) {
        ...
        const backupCodesResponse = await generateBackupCodes()
      ...
      <Modal show={showSetupModal} focus={cancelButtonRef} onClose={closeSetupModal} size='large'>
        <Modal.Content>
          <div className='text-center sm:text-left w-full'>
            ...
            {currentStep === 4 && (
              <div className='text-center'>
                <FontAwesomeIcon icon={faCircleCheck} className='h-16 w-16 text-green-500 mb-4' />
                <h4 className='text-base font-medium text-gray-900 dark:text-gray-100 mb-4'>
                  {t('Settings.Two-Factor Authentication Enabled!')}
                </h4>
                <p className='text-sm text-gray-600 dark:text-gray-400 mb-6'>
                  {t(
                    'Settings.Save these backup codes in a safe place. You can use them to access your account if you lose your authenticator device.',
                  )}
                </p>
                  ...
                  <div className='flex items-start'>
                    ...
                    <div className='text-left'>
                      ...
                      <p className='text-xs text-amber-700 dark:text-amber-300'>
                        {t(
                          'Settings.Each backup code can only be used once. Keep them safe and secure.',
                        )}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='flex items-center justify-between'>
                    <div className='text-left'>
                      <h5 className='text-sm font-medium text-gray-900 dark:text-gray-100 mb-1'>
                        {t('Settings.Backup Codes')}
                      </h5>
                      <p className='text-xs text-gray-600 dark:text-gray-400'>
                        {t('Settings.Download your backup codes to keep them safe')}
                      </p>
                    </div>
                    <Button
                      variant='white'
        ...
        <Modal.Content>
          <div className='text-center w-full'>
            ...
            <div className='flex items-center justify-center'>
              <div className='bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4 mb-6'>
                <div className='flex items-start'>
                  <FontAwesomeIcon
                    icon={faTriangleExclamation}
                    className='h-5 w-5 text-red-600 dark:text-red-400 mr-3'
                  />
                  <div className='text-left'>
                    <p className='text-sm font-medium text-red-800 dark:text-red-200'>
                      {t('Settings.This will make your account less secure.')}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className='mb-4 text-center'>
              <p className='text-sm text-gray-600 dark:text-gray-400 mb-4'>
                {t('Settings.Enter your authenticator code to confirm')}
              </p>
            </div>
