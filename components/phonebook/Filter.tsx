...
const filters = [
  ...
  },
  {
    ...
    options: [
      { value: 'all', label: 'All' },
      { value: 'centralized', label: 'Centralized phonebook' },
      { value: 'nethcti', label: 'Personal phonebook' },
    ],
  },
]
...
export const Filter = forwardRef<HTMLButtonElement, FilterProps>(({ className, ...props }, ref) => {
